...
| `CS_BENCH_MG_DESCENT_SMOOTHER_TYPE` | `pcg`, `fcg`, `jacobi`, `gs`, `sgs`, `l1_jacobi`, `relaxed_jacobi`, `rj2`, `rj3`, `tfgs`, `tbgs` | Descent smoother type (default: sgs on CPU, jacobi on GPU) |
...
| `CS_BENCH_MG_DESCENT_SMOOTHER_TYPE_D` | `pcg`, `fcg`, `jacobi`, `l1_jacobi`, `relaxed_jacobi`, `rj2`, `rj3` | Descent smoother type for device. |
| `CS_BENCH_MG_ASCENT_SMOOTHER_TYPE_D` | same as above | Ascent smoother type for device. |
